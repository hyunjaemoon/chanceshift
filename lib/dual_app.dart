...
class MyDualApp extends StatefulWidget {
  const MyDualApp({super.key});

  @override
  // ignore: library_private_types_in_public_api
  _MyDualAppState createState() => _MyDualAppState();
}

class _MyDualAppState extends State<MyDualApp> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: TwoPane(
        ...
        // Proportion of the available space occupied by the first game
